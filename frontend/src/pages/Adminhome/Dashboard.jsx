...
const Dashboard = () => {
  ...
  return (
    <div>
       <div>
          <div  className="text-slate-600 mx-auto grid w-full grid-cols-2 gap-y-4 px-4 py-1 sm:my-10 sm:rounded-md sm:border sm:shadow">
            ...
            <div className="col-span-2 -mx-4 bg-gradient-to-t from-indigo-500 to-blue-500 px-4 py-8 sm:col-span-1 sm:mx-0 sm:rounded-xl sm:py-4">
              <p className="mb-4 font-medium text-indigo-100">Total data</p>
              <div className="mb-6 flex max-w-xs">
                ...
                <div className="px-4">
                  <p className="mb-1 text-2xl font-black text-white"> graphical data</p>
                  <p className="font-medium text-indigo-100"></p>
                </div>
              </div>
